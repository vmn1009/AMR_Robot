...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.teams = 1;
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(RobotListenerConfig::AbstractParamDescriptionConstPtr(new RobotListenerConfig::ParamDescription<int>("teams", "int", 0, "A size parameter which is edited via an enum", "{'enum_description': 'An enum to set size', 'enum': [{'srcline': 13, 'description': 'A small data', 'srcfile': '/home/eric/catkin_ws/src/yb-car-vm/yahboomcar_multi/cfg/RobotListener.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'convoyl'}, {'srcline': 14, 'description': 'A medium data', 'srcfile': '/home/eric/catkin_ws/src/yb-car-vm/yahboomcar_multi/cfg/RobotListener.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'vertical'}, {'srcline': 15, 'description': 'A large data', 'srcfile': '/home/eric/catkin_ws/src/yb-car-vm/yahboomcar_multi/cfg/RobotListener.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'horizonta'}]}", &RobotListenerConfig::teams)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(RobotListenerConfig::AbstractParamDescriptionConstPtr(new RobotListenerConfig::ParamDescription<int>("robot_model", "int", 0, "A size parameter which is edited via an enum", "{'enum_description': 'An enum to set size', 'enum': [{'srcline': 19, 'description': 'A medium data', 'srcfile': '/home/eric/catkin_ws/src/yb-car-vm/yahboomcar_multi/cfg/RobotListener.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'omni'}, {'srcline': 20, 'description': 'A large data', 'srcfile': '/home/eric/catkin_ws/src/yb-car-vm/yahboomcar_multi/cfg/RobotListener.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'diff'}]}", &RobotListenerConfig::robot_model)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(RobotListenerConfig::AbstractParamDescriptionConstPtr(new RobotListenerConfig::ParamDescription<int>("robot_model", "int", 0, "A size parameter which is edited via an enum", "{'enum_description': 'An enum to set size', 'enum': [{'srcline': 19, 'description': 'A medium data', 'srcfile': '/home/eric/catkin_ws/src/yb-car-vm/yahboomcar_multi/cfg/RobotListener.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'omni'}, {'srcline': 20, 'description': 'A large data', 'srcfile': '/home/eric/catkin_ws/src/yb-car-vm/yahboomcar_multi/cfg/RobotListener.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'diff'}]}", &RobotListenerConfig::robot_model)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.navigate = 0;
...
//#line 13 "/home/eric/catkin_ws/src/yb-car-vm/yahboomcar_multi/cfg/RobotListener.cfg"
      const int RobotListener_convoyl = 0;
//#line 14 "/home/eric/catkin_ws/src/yb-car-vm/yahboomcar_multi/cfg/RobotListener.cfg"
      const int RobotListener_vertical = 1;
//#line 15 "/home/eric/catkin_ws/src/yb-car-vm/yahboomcar_multi/cfg/RobotListener.cfg"
      const int RobotListener_horizonta = 2;
//#line 19 "/home/eric/catkin_ws/src/yb-car-vm/yahboomcar_multi/cfg/RobotListener.cfg"
      const int RobotListener_omni = 0;
//#line 20 "/home/eric/catkin_ws/src/yb-car-vm/yahboomcar_multi/cfg/RobotListener.cfg"
