...
if("TRUE" STREQUAL "TRUE")
  set(amr_description_SOURCE_PREFIX /home/eric/catkin_ws/src/amr/amr_description)
  set(amr_description_DEVEL_PREFIX /home/eric/catkin_ws/devel)
  ...
  set(amr_description_INSTALL_PREFIX /home/eric/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'amr_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eric/catkin_ws/src/amr/amr_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT amr_description_NUM_DUMMY_TARGETS)
      set(amr_description_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::amr_description::wrapped-linker-option${amr_description_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR amr_description_NUM_DUMMY_TARGETS "${amr_description_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::amr_description::wrapped-linker-option${amr_description_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND amr_description_LIBRARIES "${interface_target_name}")
